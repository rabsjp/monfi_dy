...
class Question2(Page):
    ...
    def vars_for_template(self):
        ...
        probabilities_list = {"1": 1/8, "2": 3/8, "3": 3/8, "4": 1/8}
        ...
        return {
            ...
            'bond': json.dumps(bond_list),
            'realized_states': json.dumps(states_list),
            'prob': json.dumps(probabilities_list)
        }
...
class Question8(Page):
    ...
    def vars_for_template(self):
        ...
        wealth_list = {"w_0_1": 100, "w_1_1": 150, "w_1_2": 75, "w_2_1": 210,
                       "w_2_2": 120, "w_2_3": 53, "w_2_4": 53, "w_3_1": 290,
                       "w_3_2": 170, "w_3_3": 95, "w_3_4": 32, "w_3_5": 95,
                       "w_3_6": 95, "w_3_7": 32, "w_3_8": 32
                       }
        stock_list = {"s_0_1": 50, "s_1_1": 60, "s_1_2": 45, "s_2_1": 80,
                      "s_2_2": 50, "s_2_3": 42, "s_2_4": 42
                      }
        bond_list = {"b_0_1": 50, "b_1_1": 90, "b_1_2": 30, "b_2_1": 130,
                     "b_2_2": 70, "b_2_3": 11, "b_2_4": 11
                     }
        states_list = {"0": "", "1": "", "2": "", "3": ""}
